...
public class ReservaDeConsultas {
    ...
    @Autowired List<ValidadorCancelamientoDeConsulta> validadoresCancelamiento;
    ...
    if (datos.especialidad()== null){
        throw new ValidacionException("Es necesario elegir una especialidad cuando no se elige el un medico");
    }
